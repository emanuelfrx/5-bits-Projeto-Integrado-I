...
function EventUpdate() {
    ...
    // get data of event and set in inputs
    ...
    const updateevent = async (inputs) => {
        const res = await makeRequest.post("/events/event_update", inputs, {
        ...
        <div className="lg:max-w-5xl mx-auto">
            ...
            < div className="sm:flex sm:justify-between sm:items-center mb-8" >
                ...
                < div className="mb-4 sm:mb-0" >
                    <h1 className="text-2xl md:text-3xl dark:text-gray-100 font-bold">Eventos - Editar Evento</h1>
                </div >
